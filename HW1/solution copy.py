...
def select_feat(train_data, valid_data, test_data, select_all=True):
    ...
    if select_all:
        ...
        # feat_idx = list(range(37, 117))
        
        # feat_idx = []
        # for i in range(1, 5):
        #     feat_idx.append(i * 16 + 37)
...
train_data, test_data = pd.read_csv('D:\MaoLiang\VSCode\ML_2022\HW1\covid.train.csv').values, pd.read_csv('D:\MaoLiang\VSCode\ML_2022\HW1\covid.test.csv').values
